...
function renderProductCard(product, container) {
    ...
    card.innerHTML = `
        ...
        <div class="card-content">
            ...
            <div class="card-actions">
                <a href="products.html?id=${id}" class="btn-details">Product Details</a>
                <button
                    type="button"
                    class="btn-add-cart"
                    id="btn-add-${id}"
    ...
    card.querySelector('.btn-add-cart').addEventListener('click', (e) => {
        handleAddToCart(e.currentTarget, product);
    });
        ...
        detailCard.innerHTML = `
            ...
            <div class="product-detail-info">
                ...
                <div class="product-actions" style="margin-top:20px;">
                    ...
                    <button type="button" class="add-cart-button" id="btn-detail-add" style="background:#0077b6; color:white; border:none; padding:12px 24px; border-radius:8px; font-size:1rem; font-weight:700; cursor:pointer; transition:all 0.2s;">Add to Cart</button>
                </div>
            </div>
        `;
